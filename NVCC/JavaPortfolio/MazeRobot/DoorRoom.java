...
It establishes the DoorRoom class, creating a maze for the robot to navigate

I edited it by creating 2 new data fields to keep track of the amount of columns and rows in each
object of the class, so that the robot can know when it has reached the final room. I added statements in 
both constructor methods to update the data fields appropriately.
...
public class DoorRoom {
	...
	int cols = 0; //my addition
	int rows = 0; //my addition
	...
	public DoorRoom(String map) {
		...
		this.init();
		this.cols = cols;				//my addition
		this.rows = rows.length;		//my addition
	}
	...
	public DoorRoom(int w, int h) {
		...
		this.init();
		this.cols = w;		//my addition
		this.rows = h;		//my addition
	}
